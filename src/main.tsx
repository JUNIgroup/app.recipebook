...
import { STORAGE_KEY_EMAIL } from './app.constants'
...
import { storagePersistence } from './infrastructure/firebase/persistence'
import { App } from './presentation/app'
import { createConsoleLogger, createDebugObserver } from './utilities/logger'

import './main.scss'

const solidDevtools = import.meta.env.DEV ? import('solid-devtools') : undefined
